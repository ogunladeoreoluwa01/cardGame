              ...
              <span className="flex items-center gap-3">
                {element &&
                  element.map((el, index) => (
                    <div
                      ...
                      className="w-7 h-7 p-1 flex items-center justify-center rounded-sm rotate-[45deg] text-xl border-white "
                    >
                ...
                {petClass && (
                  <div
                    ...
                    className="w-7 h-7 p-1 rotate-[45deg] flex items-center justify-center text-white rounded-sm  border-white"
                  >
                    <span className="-rotate-[45deg] text-[0.9rem]">
