...
const DeckCardComp: React.FC<Props> = ({
  ...
  return (
    <Card
      className={`card saturate-150 rounded-sm w-[170px] h-[275px]  cursor-pointer      p-[0.22rem] relative overflow-hidden ${rarityStyle} font-mono`}
    >
      <div
      ...
      >
        ...
        <section className="w-full h-[185px]   bg-black rounded-t-[0.5rem] relative">
          {isListed && (
