...
import MarketCardLoader from "./marketLoader";
...
const MarketPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleClearButton = () => {
      ...
      newParams.delete("minValue");
      newParams.delete("maxValue");
                ...
                <div className="flex   justify-center items-center gap-1 min-w-10">
                  ...
                  {isLoading ? (
                    ...
                    <p className=" uppercase text-sm text-center font-bold">
                      {" "}
                      <NumberCounter number={data?.userInfo?.profile?.Aureus} />
                    </p>
                  )}
                </div>
              </li>
              ...
              <span className="flex items-center gap-3">
                {element &&
                  element.map((el, index) => (
                    <div
                      ...
                      className="w-7 h-7 p-1 flex items-center justify-center rounded-sm rotate-[45deg] text-xl border-white border-1"
                    >
                ...
                {petClass && (
                  <div
                    ...
                    className="w-7 h-7 p-1 rotate-[45deg] flex items-center justify-center text-white rounded-sm border-1 border-white"
                  >
                    <span className="-rotate-[45deg] text-[0.9rem]">
