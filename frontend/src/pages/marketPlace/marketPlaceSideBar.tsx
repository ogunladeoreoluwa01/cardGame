        ...
        <section className=" lg:w-[18vw] md:w-[650px]   w-full h-fit hidden lg:flex flex-wrap flex-col gap-1 p-2 border-[2px] border-gray-400 bg-black backdrop-filter backdrop-blur-lg bg-opacity-10 text-secondary-foreground shadow-sm rounded-lg transition-all duration-300 ease-linear">
          <section className=" flex flex-col flex-wrap w-full gap-2 items-center">
            ...
            <section className="flex w-full flex-col gap-1">
              ...
              <h1 className="px-2 my-1 font-bold flex items-center gap-1">
                Price Filter
                <p className=" text-muted-foreground text-xs"> {priceFilter}</p>
              </h1>
              <div className="flex  w-full px-2 items-center space-x-2">
                <Label htmlFor="airplane-mode">Low</Label>
                <Switch
                  id="airplane-mode"
                  checked={isHigh} // Bind the checked state to isHigh
                  onCheckedChange={handleSwitchChange} // Handle the switch change
                />
                <Label htmlFor="airplane-mode">High</Label>
              </div>
            </section>
          </section>
        </section>{" "}
